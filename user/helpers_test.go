...
func Test_AsSerializableUser_Interface(t *testing.T) {
	serializableUser := mockShoreline.asSerializableUser(&User{}, false)
...
func Test_AsSerializableUser_UserId(t *testing.T) {
	...
	serializableUser := mockShoreline.asSerializableUser(user, false).(map[string]interface{})
...
func Test_AsSerializableUser_PasswordExists_True_Server(t *testing.T) {
	...
	serializableUser := mockShoreline.asSerializableUser(user, true).(map[string]interface{})
