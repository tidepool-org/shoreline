...
require (
	...
	github.com/tidepool-org/go-common v0.7.2-0.20201109214807-a06e88000d5d
	github.com/urfave/cli v1.22.4
	go.mongodb.org/mongo-driver v1.4.1
	go.opentelemetry.io/contrib/instrumentation/github.com/Shopify/sarama/otelsarama v0.13.0 // indirect
